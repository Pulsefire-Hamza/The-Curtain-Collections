...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-900 via-gray-800 to-black text-gray-200 py-16 px-6">
      <div className="container mx-auto flex flex-wrap justify-between space-y-12 md:space-y-0 md:flex-nowrap">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center md:items-start space-y-8">
          ...
          <h4 className="text-4xl font-serif text-white">Stay Updated!</h4>
          <p className="text-gray-300 text-base md:text-lg">Subscribe to get the latest updates on men's collections, offers, and more.</p>
          <div className="flex flex-col w-full max-w-sm space-y-4">
            ...
            />
            <button className="bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-700 transition-all duration-300 transform hover:scale-105">
              Subscribe Now
            </button>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/3 text-center md:text-left space-y-8 mt-8 md:mt-0">
          <h4 className="text-4xl font-serif text-white">Find Us</h4>
        ...
        <div className="w-full md:w-1/3 text-center md:text-left space-y-8 mt-8 md:mt-0">
          ...
          <p className="text-gray-300 text-base mt-4">
            Shop Name: The Men's Collection <br />
